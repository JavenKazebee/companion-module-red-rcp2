...
export default function updateVariableDefinitions(self: ModuleInstance): void {
	self.setVariableDefinitions([
		...
		{ variableId: 'lens_hyperfocal_distance', name: 'Lens Hyperfocal Distance' },
		...
		{ variableId: 'media_percentage_remaining', name: 'Media Percentage Remaining' },
		...
		{ variableId: 'prores_baked_in_settings', name: 'ProRes Baked In Settings' },
		...
		{ variableId: 'rf_iris_compensation_enable', name: 'RF Iris Compensation Enable' },
		...
		{ variableId: 'wifi_infrastructure_ssid', name: 'Wifi Infrastructure SSID' },
