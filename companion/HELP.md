...
Compatible with all RED cameras using the RCP2 protocol, which is all of the DSMC3 line.

Has been tested and verified working with:
...
Communication > Connections > Wi-Fi
